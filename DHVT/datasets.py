...
try:
    ...
    ImageFolderLMDB = None

# CIFAR-100 official fine label → coarse (superclass) label mapping
...
def build_dataset(is_train, args):
    ...
    if args.data_set == 'CIFAR':
        ...
        if args.use_lmdb:
            if ImageFolderLMDB is None:
                raise ImportError("folder2lmdb is not available. Install it or disable --use-lmdb.")
    ...
    fine_to_coarse = CIFAR100_FINE_TO_COARSE if args.data_set == 'CIFAR' else None
    return dataset, nb_classes, fine_to_coarse
